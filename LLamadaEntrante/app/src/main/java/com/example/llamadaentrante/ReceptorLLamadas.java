...
public class ReceptorLLamadas extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Notification notificacion = new Notification( R.drawable.ic_launcher,"Llamada entrante",
                System.currentTimeMillis());
        PendingIntent intencionPendiente = PendingIntent.getActivity( context, 0, newIntent(context,
                LlamadaEntranteActivity.class), 0);
